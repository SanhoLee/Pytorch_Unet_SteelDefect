...
class UNet(nn.Module):
    def __init__(self):
        ...
        def CBR2d(in_channels, out_channels, kernel_size=3, stride=1, padding=1, bias=True):
            layers = []
            # create Conv2d, Batch and Relu Layer and and make sequential single layer.
            layers += [nn.Conv2d(
            ...
            # if it you do hard-coding...
            # cbr = nn.Sequential(nn.Conv2d(...), nn.BatchNorm2d(...), nn.ReLU())
            return cbr
...
##
    def forward(self, x):
        ...
        cat4 = torch.cat((unpool4, enc4_2), dim=1)  # dim = row-direction : 0 , col-direction(channel-direction) : 1
